...
EXPANSION_PATH = (
    ...
    / "yeshivish_glossary_gemara_shabbos_expansion.json"
)
MODEL_FIELDS = (
    "aleph_beis",
    "dialect_pattern",
...
def import_expansion(apps, schema_editor):
    ...
    rav.variants = [
        variant for variant in rav.variants if variant.casefold().strip() != "rov"
    ]
    rav.save(update_fields=["variants"])
...
class Migration(migrations.Migration):
    dependencies = [("translator", "0004_glossaryterm_aleph_beis")]
